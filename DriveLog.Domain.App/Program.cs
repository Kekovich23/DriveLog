...
var race = new Race(track.Id, DateTimeOffset.UtcNow);
...
var rnd = new Random();
for (var i = 0; i < 3; i++) {
    var raceLap = new RaceLap(race.Id, driver.Id, car.Id, i + 1, TimeSpan.FromMilliseconds(90000 + rnd.Next(30000)));
    Console.WriteLine($"Driver \"{driver.Number.Value} {driver.FullName}\"" +
