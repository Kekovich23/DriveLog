        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Car_Number", "\"Number\" > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Driver_Number", "\"Number\" > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RaceLaps_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RaceLaps_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RaceLaps_CarId",
                table: "RaceLaps",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_RaceLaps_DriverId",
                table: "RaceLaps",
                column: "DriverId");
